...
>>>>>>> c99168c2ef1181c487a4b0d85cb9f55ac094e401:web/src/views/PublishBook.vue
      ...
      <el-scrollbar>
        <div class="fradtWrap" v-show="currentType == 2">
          <div class="card" v-for="draft in draftList" :key="draft.id" @click="chooseThisDraft(draft)" :class="{ 'active': form.draft == draft.id ? true : false }">
            <el-icon>
              <SuccessFilled />
            </el-icon>
      ...
      <el-input v-model="form.desc" :rows="5" type="textarea" class="cusArea" placeholder="Write a description of your drawing, such as a part, how it dif"></el-input>
