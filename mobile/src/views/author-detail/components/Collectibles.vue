      ...
      >
        <ul class="books-wrapper" v-if="list.length">
          <li v-for="(item,index) in list" :key="index">
            <img :src="item.issue.book.cover_url" alt="" class="cover" />
            <div class="book-info">
              <div class="avtar">
                <img :src="item.issue.book.author.avatar_url" alt=""/>
                <span>{{item.issue.book.author.name}}</span>
              </div>
              <p class="intro">{{item.issue.book.title}}</p>
              <ol class="price">
                <li>
                  <p class="label">Floor price</p>
                  <p class="value">{{item.issue.price}}USDC</p>
                </li>
                <li>
                  <p class="label">Circulation </p>
                  <p class="value">{{item.issue.quantity}}</p>
                </li>
                <li>
                  <p class="label">Destruction</p>
                  <p class="value">{{item.issue.n_circulations}}</p>
                </li>
              </ol>
            </div>
          </li>
...
<script>
import { queryCollection } from "@/api/author";
export default {
  name: "Collectibles",
  mixins: [],
  components: {},
