...
<template>
  <div class="main">
    ...
    <div class="content">
      ...
      <div class="typeWrap">
        ...
        <div class="typeRight">
          ...
          <el-upload action="#" :show-fileList="false" :auto-upload="false" :on-change="changeBanner"
            class="fullUpload">
            <div class="plusIcon">
      ...
      <div class="title_">User name</div>
      <el-input class="cusInput" v-model="form.name"></el-input>
      <div class="title_">Description</div>
      <el-input v-model="form.desc" type="textarea" class="cusAreaBorder" placeholder="Introduce yourself..."
        show-word-limit maxlength="500" :autosize="{ minRows: 3, maxRows: 6 }"></el-input>
      ...
      <div class="title_">Discord community</div>
    ...
    <Footer></Footer>
    <input id="input" value="这是文字拷贝容器" style="opacity:0;position:fixed;" />
  </div>
</template>
