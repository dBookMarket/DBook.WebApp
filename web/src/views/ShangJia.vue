...
const form = ref({
  book: "",
  price: 0, quantity: 1, royalty: 0, buy_limit: 1, published_at: '',
  duration: 60,
  token: {
    block_chain: "bnb",
    currency: "USDC"
...
const createBook = async () => {
  ...
  if (provider) {
    ...
    console.log(form.value.token.block_chain)
    // 先查看是否授权过
...
<template>
  <div class="main">
    ...
    <div class="content">
      ...
      <el-input class="cusInput" v-model="form.token.currency"></el-input>
      <div class="title_">单价</div>
      <el-input-number v-model="form.price"></el-input-number>
      <div class="title_">版税</div>
      <el-input-number v-model="form.royalty"></el-input-number>
      ...
      <el-input-number v-model="form.buy_limit"></el-input-number>
